                ...
                <div className="flex items-center w-full space-x-2 max-w-[100%]">
                    ...
                    <div className="flex flex-1 chat-item-list w-3/4">
                        <div className="flex flex-col w-11/12">
                            <div className={`text-lg dark:text-white ${unread > 0 && "font-semibold"}`}>
                                {name}
                                <span className={`flex items-center justify-center h-6 absolute top-4 right-4 text-sm ${unread > 0 ? "text-unread-light dark:text-unread-dark" : "text-gray-400"}`}>
                            ...
                            <div className="flex items-center">
                                ...
                                <div className={`text-gray-500 truncate text-sm dark:text-white ${unread > 0 && " font-semibold"}`}>
